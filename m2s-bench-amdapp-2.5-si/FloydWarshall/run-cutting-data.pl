...
foreach $length (@fifo_list)
{
    for($cut = 1; $cut <= $N_TOP; $cut = $cut + 1)
    {
            ...
            $temp_add = "./trained-data/add"."_$length.txt";
            $temp_mul = "./trained-data/mul"."_$length.txt";
            $temp_muladd = "./trained-data/muladd"."_$length.txt";
            $temp_sqrt = "./trained-data/sqrt"."_$length.txt";
            $temp_mad = "./trained-data/mad"."_$length.txt";
