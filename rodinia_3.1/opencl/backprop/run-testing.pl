...
$dist = 0;
@fdist = (0, 0.015625, 0.03125, 0.0625, 0.125, 0.25, 0.5, 1000);
@buffsize = (0);
$ENV{M2S_OPENCL_BINARY}='/home/dperoni/rodinia_3.1/opencl/backprop/backprop_kernel.bin';
...
system("~/CFPU/multi2sim-4.2/bin/m2s --si-sim detailed --si-fifo-length $length --si-profiling 0 --si-hamming-dist $dist --si-tcam-dist $fd --si-abuff-size $bf  --si-config conf backprop 512 > hit.rep");
