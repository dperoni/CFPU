...
$dist = 0;
@fdist = (0, 0.007, 0.0162, 0.03125, 0.0625, 0.125, 0.25, 1);
@buffsize = (0);
...
system("~/approximate_associative_mem_gpu/multi2sim-4.2/bin/m2s --si-sim detailed --si-fifo-length $length --si-profiling 0 --si-hamming-dist $dist --si-tcam-dist $fd --si-abuff-size $bf  --si-config conf lud -v -i ../../../data/lud/64.dat > hit.rep");
