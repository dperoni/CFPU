...
#define EXACT 0
#define MANTISSA_DROP 1
#define ADAPTIVE 2
#define TUNING 3
#define SHIFT_AND_ADD 4
#define SA_TUNE 5
#define ADAPTIVE_SIMPLE 6
#define ADAPTIVE_SIMPLE_TUNING 7
extern int CFPU_MODE;

extern int PROFILING;
extern unsigned int fifo_length;
extern int HAMMING_THR;
extern float CFPU_MAX_ERROR;
extern float TCAM_REW;
extern int ABUFF_SIZE;
/*
 * Class 'SIEmu'
 */
